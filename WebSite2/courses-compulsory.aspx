<%@ Page Language="C#" AutoEventWireup="true" CodeFile="courses-compulsory.aspx.cs" Inherits="courses_compulsory" %>
                ...
                <div class="col-12 col-lg-8">
                    <div class="featured-courses courses-wrap">
                        <div class="row mx-m-25">
                            ...
                            <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" Width="360px" DataSourceID="odsCourseTongshi">
                                <ItemTemplate>
                                     <a href='single-courses.aspx?课程编号=<%# DataBinder.Eval(Container.DataItem,"课程编号") %>'>
                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("课程用书图片路径")%>' align="center" Width="160px" Height="160px"/>
                                    <br/>
                                    <h5>
                                        <asp:Label ID="lbl课程编号" runat="server" Text='<%# Eval("课程编号") %>' Width="270px" />
                                    </h5>
                                    <asp:Label ID="课程名Label" runat="server" Text='<%# Eval("课程名") %>' Width="270px" />
                                    </h5>
                                    <i>
                                    <asp:Label ID="开设学院名Label" runat="server" Text='<%# Eval("开设学院名") %>' /></i>
                                    <br/>
                            ...
                            <asp:ObjectDataSource ID="odsCourseTongshi" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByCoursetype" TypeName="MainDataSetTableAdapters.课程TableAdapter" DeleteMethod="Delete" InsertMethod="Insert" UpdateMethod="Update">
                                <DeleteParameters>
